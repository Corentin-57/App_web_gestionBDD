    ...
    <ul class="navbar-nav mr-auto">
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdown01">
          <a class="dropdown-item" href="/App_joueurs/listjoueur">Lister les joueurs</a>
          <a class="dropdown-item" href="/App_joueurs/listeTournois">Lister les tournois</a>
        </div>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdown01">
          <a class="dropdown-item" href="/App_joueurs/ajouterJoueur">Ajouter un joueur</a>
          <a class="dropdown-item" href="/App_joueurs/ajouterTournoi">Ajouter un tournoi</a>
        </div>
      </li>

      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Recherche avancée</a>
        <div class="dropdown-menu" aria-labelledby="dropdown01">
          <a class="dropdown-item" href="/App_joueurs/rechercheMatchs">Matchs</a>
          <a class="dropdown-item" href="/App_joueurs/rechercheEpreuves">Epreuves</a>
        </div>
      </li>
	</ul>
	<ul class="navbar-nav">
